...
# carregando as bases de dados das edições de 2016, 2017 e 2018 do enade
...
df_enade.to_csv('enade_todas_as_inscricoes.csv', index=False)
...
profile.to_file("profiling_enade_todas_as_inscricoes.html")

df_enade = df_enade[df_enade['PRESENCA_ENADE']=='555']
df_enade.drop('PRESENCA_ENADE', axis=1, inplace=True)
df_enade.reset_index(drop=True, inplace=True)

df_enade.to_csv('enade_presencas_validas_com.csv', index=False)
...
profile.to_file("profiling_enade_presencas_validas_com.html")

df_enade.dropna(inplace=True)
df_enade.reset_index(drop=True, inplace=True)

df_enade.to_csv('enade_presencas_validas_sem.csv', index=False)
...
profile.to_file("profiling_enade_presencas_validas_sem.html")